...
import { kev, log, project } from "@adriangalilea/utils";
...
const tests = [
	...
	{
		key: "API_KEY",
		expected: "api_key_456",
		description: "API-specific variable",
	},
	...
	{
		key: "MONOREPO_NAME",
		expected: "test-monorepo",
		description: "Monorepo-level variable",
	},
	{
		key: "MONOREPO_ENV",
	...
	{
		key: "DATABASE_URL",
		expected: "postgres://localhost/api_specific_db",
		description: "Should be overridden by API .env",
	},
	{
		key: "SHARED_SECRET",
		expected: "api_override_secret",
		description: "Should be overridden by API .env",
	},
...
console.log(
	`  ${monorepoEnvPath}:MONOREPO_NAME =`,
	kev.get(`${monorepoEnvPath}:MONOREPO_NAME`),
);
